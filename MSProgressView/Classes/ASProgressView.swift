...
//  ASProgressView
//
//  Created by Muhammad Abdul Subhan on 23/06/2017.
...
open class ASProgressView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        self.boxColor = ASDefaultColor.defaultBackgroundColor
        self.iconColor = ASDefaultColor.defaultIconColor
        self.iconBgColor = ASDefaultColor.defaultBackgroundColor
